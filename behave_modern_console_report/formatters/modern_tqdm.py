"""Formatter using tqdm for a robust live progress bar."""
...
class ModernTqdmFormatter(BaseFormatter):
    """Playwright-like report using tqdm for the progress bar."""

    name = "modern-tqdm"
    description = "Modern report with tqdm progress bar (broad terminal support)"
